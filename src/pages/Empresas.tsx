                ...
                <CardHeader className={cn("bg-[#F7F8F4] py-4", associationRecentsExpanded && "border-b")}>
                  <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <CardTitle className="text-lg text-[#1C1C1C]">Últimas empresas associadas</CardTitle>
                        <p className="text-sm text-muted-foreground">
                          Ordem da associação mais recente para a mais antiga e tempo de vínculo com o sindicato.
                        </p>
                      </div>
                    </div>
                    <Button
